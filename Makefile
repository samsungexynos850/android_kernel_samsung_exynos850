...
ARCH		?=arm64
CROSS_COMPILE   ?= /home/risky/toolchains/gcc-4.9/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
AS		= $(CROSS_COMPILE)as
LD		= $(CROSS_COMPILE)ld
CC    = /home/risky/toolchains/gcc-4.9/clang/host/linux-x86/clang-r353983c/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE    ?= /home/risky/toolchains/gcc-4.9/clang/host/linux-x86/clang-r353983c/bin/aarch64-linux-gnu-
